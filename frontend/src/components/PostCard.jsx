...
const PostCard = ({ userData, post, reels, code }) => {
  return (
    <div className="w-full p-2 border  bg-gray-100 shadow-lg rounded-lg">
      <div className="relative">
        {code && (
          <a
            ...
            className="absolute top-2 right-2 aspect-square flex items-center justify-center text-white bg-blue-700  hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg p-3  focus:outline-none "
          >
            <OpenIcon />
          </a>
        )}
        ...
        >
          <img
            ...
            loading="lazy"
            className={`w-full h-auto border object-cover rounded-lg ${
      ...
      <div className="flex mt-2 gap-1">
        ...
        >
          <img
            ...
            loading="lazy"
            className="rounded-full md:h-12 h-8 w-auto border aspect-square"
          />
        </a>
        <div className="ml-1 ">
          <a
          ...
          <div className="flex">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="md:text-xs text-[10px] text-black"
            >
              @{userData?.username}
            </a>
            {userData?.isVerified && (
